...
public class DataMenager : MonoBehaviour
{
    ...
    public int ShotBullet
    {
        ...
        {
            shotBullet = value;
            GameObject.Find("ShotBulletText").GetComponent<Text>().text = " KURÞUN : " + shotBullet.ToString();
        }
    }
    ...
    public int EnemyKilled
    {
     ...
     set
        {
            enemyKilled = value;
            GameObject.Find("EnemyKilledText").GetComponent<Text>().text = " LEÞ : " + enemyKilled.ToString();
            WinProcess();
        }
    }
